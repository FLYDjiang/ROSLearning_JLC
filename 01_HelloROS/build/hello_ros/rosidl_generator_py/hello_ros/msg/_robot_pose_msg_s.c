...
bool hello_ros__msg__robot_pose_msg__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("hello_ros.msg._robot_pose_msg.RobotPoseMsg", full_classname_dest, 42) == 0);
  }
  hello_ros__msg__RobotPoseMsg * ros_message = _ros_message;
  {  // x
...
{
  /* NOTE(esteve): Call constructor of RobotPoseMsg */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("hello_ros.msg._robot_pose_msg");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "RobotPoseMsg");
